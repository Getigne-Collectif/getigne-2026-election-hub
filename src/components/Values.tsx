              ...
              <div className="grid md:grid-cols-2 gap-10">
                  ...
                  <ul className="space-y-6">
                    <li className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-getigne-700">Nous croyons à l'entraide et à la cohésion sociale pour ne laisser personne de côté et construire ensemble.</p>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      <div className="mt-1 w-10 h-10 bg-getigne-accent/10 rounded-full flex-shrink-0 flex items-center justify-center">
                        <Earth className="text-getigne-accent h-5 w-5" />
                      </div>
                      <div>
                        <h3 className="text-xl font-medium">Durable</h3>
                        <p className="text-getigne-700">Nous défendons la préservation de notre environnement et une transition écologique juste et accessible à tous.</p>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      <div className="mt-1 w-10 h-10 bg-getigne-accent/10 rounded-full flex-shrink-0 flex items-center justify-center">
                        <Star className="text-getigne-accent h-5 w-5" />
                      </div>
                      <div>
                        <h3 className="text-xl font-medium">Démocratique</h3>
                        <p className="text-getigne-700">Nous promouvons l'implication de chaque citoyen dans les décisions qui concernent notre commune.</p>
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-6">
                    <li className="flex gap-4">
                      <div className="mt-1 w-10 h-10 bg-getigne-accent/10 rounded-full flex-shrink-0 flex items-center justify-center">
                        <Megaphone className="text-getigne-accent h-5 w-5" />
                      </div>
                      <div>
                        <h3 className="text-xl font-medium">Informer</h3>
                        <p className="text-getigne-700">Apporter une information transparente et accessible sur les enjeux locaux et les actions municipales.</p>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      <div className="mt-1 w-10 h-10 bg-getigne-accent/10 rounded-full flex-shrink-0 flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <p className="text-getigne-700">Rassembler les citoyens autour de projets concrets pour améliorer notre cadre de vie et notre vivre-ensemble.</p>
                      </div>
                    </li>
                    <li className="flex gap-4">
                      <div className="mt-1 w-10 h-10 bg-getigne-accent/10 rounded-full flex-shrink-0 flex items-center justify-center">
                        <Grab className="text-getigne-accent h-5 w-5" />
                      </div>
                      <div>
                        <h3 className="text-xl font-medium">Agir</h3>
                        <p className="text-getigne-700">Porter des initiatives concrètes pour un développement harmonieux, durable et inclusif de notre commune.</p>
                      </div>
                    </li>
                  </ul>
                </div>
