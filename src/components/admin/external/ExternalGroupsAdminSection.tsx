...
type ExternalGroupsAdminSectionProps = {
  showHeader?: boolean;
};

const ExternalGroupsAdminSection = ({ showHeader = true }: ExternalGroupsAdminSectionProps) => {
...
export default ExternalGroupsAdminSection;
