    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl md:text-4xl font-bold mb-8 text-getigne-900">Mentions légales</h1>
          
          <div className="prose max-w-none">
            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-getigne-800 mb-4">Informations générales</h2>
              <p>
              ...
              <p className="mt-4">
                <strong>Directeur de la publication :</strong> Le collectif citoyen de Gétigné
              </p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-getigne-800 mb-4">Politique de confidentialité</h2>
              
              <h3 className="text-xl font-medium text-getigne-700 mt-6 mb-3">Collecte des données personnelles</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-getigne-700 mt-6 mb-3">Utilisation des données</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-getigne-700 mt-6 mb-3">Conservation des données</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-getigne-700 mt-6 mb-3">Vos droits</h3>
              <p>
              ...
              <h3 className="text-xl font-medium text-getigne-700 mt-6 mb-3">Cookies</h3>
              <p>
            ...
            <section className="mb-10">
              <h2 className="text-2xl font-semibold text-getigne-800 mb-4">Propriété intellectuelle</h2>
              <p>
