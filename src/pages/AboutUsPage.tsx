  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta 
          name="description"
          content="Découvrez le Gétigné Collectif, notre histoire, nos valeurs et nos membres engagés pour une commune plus écologique, solidaire et démocratique."
        />
      </Helmet>
      ...
      <div className="min-h-screen">
        ...
        <main className="pt-24">
          ...
          <div className="bg-getigne-50 py-12">
